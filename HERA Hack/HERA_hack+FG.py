...
class observation(object):
    ...
    def __init__(self, telescope, fg, n_days, freq, delta_t, corners, beam_sigma_cutoff, resol,norm,pbeam):
        ...
        self.foreground_map = fg.foreground_map()
    ...
    def compute_vis(self, vec): #DO NOT RETURN
        ...
        vector = vec + self.foreground_map
    
        self.Adotx = np.dot(self.Amat, vector) 
